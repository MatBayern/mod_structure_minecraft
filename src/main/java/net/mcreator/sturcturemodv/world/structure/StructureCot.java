...
public class StructureCot extends ElementsSturcturemodv.ModElement {
	public StructureCot(ElementsSturcturemodv instance) {
		super(instance, 1);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 100) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("sturcturemodv", "cbt"));
				if (template == null)
					return;
