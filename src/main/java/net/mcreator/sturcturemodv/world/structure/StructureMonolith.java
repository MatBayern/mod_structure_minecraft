...
public class StructureMonolith extends ElementsSturcturemodv.ModElement {
	public StructureMonolith(ElementsSturcturemodv instance) {
		super(instance, 8);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 400) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("sturcturemod", "monolithchest"));
				if (template == null)
					return;
