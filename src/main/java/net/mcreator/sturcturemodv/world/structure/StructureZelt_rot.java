...
public class StructureZelt_rot extends ElementsSturcturemodv.ModElement {
	public StructureZelt_rot(ElementsSturcturemodv instance) {
		super(instance, 4);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("sturcturemodv", "zeltrot"));
				if (template == null)
					return;
