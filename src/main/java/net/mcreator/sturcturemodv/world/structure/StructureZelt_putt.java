...
public class StructureZelt_putt extends ElementsSturcturemodv.ModElement {
	public StructureZelt_putt(ElementsSturcturemodv instance) {
		super(instance, 6);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("sturcturemodv", "zeltputt"));
				if (template == null)
					return;
